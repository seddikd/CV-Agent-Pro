...
# Les éventuelles migrations de schéma (ajout de colonnes) s'appliquent seules
# au démarrage : elles sont idempotentes et ne touchent pas aux données. Aucune
# étape manuelle sur la base, et aucun ordre à respecter entre les versions.
